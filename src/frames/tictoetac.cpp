#include "tictoetac.h"
#include <wx/wx.h>
tictoetac::tictoetac(const wxString& title) : wxFrame(nullptr, wxID_ANY, title, wxDefaultPosition, wxSize(250,275), wxDEFAULT_FRAME_STYLE & ~wxRESIZE_BORDER){
    Centre();
